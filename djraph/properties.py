...
from djraph import abc, exception
...
class Property(abc.BaseProperty):
    ...
    :py:class:`PropertyDescriptor` by :py:class:`djraph.element.ElementMeta`.

    :param djraph.abc.DataType data_type: Str or class of data type
