...
# -*- coding: utf-8 -*-
#
# djraph documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'djraph.tex', 'djraph Documentation',
...
man_pages = [
    (master_doc, 'djraph', 'djraph Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'djraph', 'djraph Documentation',
     author, 'djraph', 'One line description of project.',
     'Miscellaneous'),
]
